...
import fi.vm.kapa.rova.soap.providers.OrganizationDataProvider;

abstract class AbstractOrgSoapService extends SpringBeanAutowiringSupport {

    @Autowired
    OrganizationDataProvider dataProvider;
